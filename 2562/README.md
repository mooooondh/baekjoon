<div class="col-md-12">
			<div class="page-header">
				<h1><span class="printable">2562번 - </span><span id="problem_title">최댓값</span>
...
<p>
	이 주어지면, 이들 중 최댓값은 85이고, 이 값은 8번째 수이다.</p>
					...
					<p>
	첫 째 줄부터 아홉 번째 줄까지 한 줄에 하나의 자연수가 주어진다. 주어지는 자연수는 100 보다 작다.</p>
					</div>
					</section>
				</div>
				<div class="col-md-12">
...
61</pre>
					...
					<div class="col-md-6">
						...
						<pre class="sampledata" id="sample-output-1">85
8</pre>
						</section>
					</div>
									</div>
